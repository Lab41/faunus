...
public class ScriptRecordReaderTest extends BaseTest {
    ...
    public void testRecordReader() throws Exception {
        ...
        ScriptRecordReader reader = new ScriptRecordReader(VertexQueryFilter.create(new EmptyConfiguration()), TaskAttemptContextFactory.createTaskAttemptContext(conf, new TaskAttemptID()));
